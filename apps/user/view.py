...
# @logger.catch()
async def NewSug(day: int,user_id:  Optional[int] = 0):
    try:
        conn = Tortoise.get_connection("default")
        # print(id,day)
        if user_id:
            if day == 0:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and to_days(add_time)=to_days(now()) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            elif day == 1:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            elif day == 2:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            elif day == 3:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            else:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and user_id={user_id}  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1  and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and user_id={user_id}  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2  and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3  and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and user_id={user_id}  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4  and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4  and user_id={user_id} GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
        else:
            if day==0:
                ...
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            elif day==2:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            elif day==3:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4 and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
            else:
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=1  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=1  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=2  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=2  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result21 = await conn.execute_query_dict(sql1)
                result22 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=3  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=3  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result31 = await conn.execute_query_dict(sql1)
                result32 = await conn.execute_query_dict(sql2)
                sql1 = f"""SELECT   stock_code,COUNT(id) as cout  FROM   stock_view_count where  stock_mk="HK" and stock_type=4  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                sql2 = f"""SELECT  stock_code,COUNT(id) as cout FROM   stock_view_count where  stock_mk="US" and stock_type=4  GROUP BY(stock_code)  ORDER BY(COUNT(id)) DESC"""  # 1天内单个市场的排名前20
                result41 = await conn.execute_query_dict(sql1)
                result42 = await conn.execute_query_dict(sql2)
        return generate_response(data={
    ...
    try:
        ...
        if  id:
            if day==0:#按天查询
                ...
                app1=await  StockViewCount.filter(add_time__range=(beginime, last_data),user_id=id).count()
                ...
                sql_page_view2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d %H') as time,count(id)  cout FROM stock_view_count where user_id='{id}' and to_days(add_time)=to_days(now()) GROUP BY  time   """  # 三天内统计
                ...
                sql_page_view2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count where user_id='{id}' and DATE_SUB(CURDATE(), INTERVAL 7 DAY) <= date(add_time) GROUP BY  time   """  # 三天内统计
                ...
                sql_page_view_list = await conn.execute_query_dict(sql_page_view)
                sql_page_view2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count where user_id='{id}' and DATE_SUB(CURDATE(), INTERVAL 1 MONTH ) <= date(add_time) GROUP BY  time   """  # 三天内统计
                sql_page_view_list2 = await conn.execute_query_dict(sql_page_view2)
                sql_page_view_list,sql_page_view_list2=mix_sql(sql_page_view_list, sql_page_view_list2)
                ...
                device_rate = await conn.execute_query_dict(sqldevice)  #1天内pc占比
                print(device_rate)
                sql11 = f"""SELECT COUNT(id) as cout FROM   stock_view_count where user_id='{id}' and  add_time>DATE_SUB(CURDATE(), INTERVAL 1 YEAR) """  # 1天内单个市场的排名前20
                ...
                sql_page_view_list = await conn.execute_query_dict(sql_page_view)
                sql_page_view2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count where user_id='{id}' and DATE_SUB(CURDATE(), INTERVAL 1 YEAR ) <= date(add_time) GROUP BY  time   """  # 三天内统计
                sql_page_view_list2 = await conn.execute_query_dict(sql_page_view2)
                sql_page_view_list,sql_page_view_list2=mix_sql(sql_page_view_list, sql_page_view_list2)
                ...
                result1 = await conn.execute_query_dict(sql1)
                result2 = await conn.execute_query_dict(sql2)
                sqldevice = f"""select sum(if(devicetype='pc',1,0)) as pc,sum(if(devicetype='h5',1,0)) as h5 ,sum(if(devicetype='app',1,0)) as app from tb_browse_logs where user_id='{id}' ;"""
                device_rate = await conn.execute_query_dict(sqldevice)  #1天内pc占比
                print(device_rate)
                app1=await  StockViewCount.filter(user_id=id).count()
                device_rate[0]["app1"]=app1
                sql_page_view = f"""SELECT DATE_FORMAT(created_at,'%Y-%m-%d') as time,count(id)  cout FROM tb_browse_logs where user_id='{id}' GROUP BY  time   """  # 三天内统计
                sql_page_view_list = await conn.execute_query_dict(sql_page_view)
                sql_page_view2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count where user_id='{id}' GROUP BY  time   """  # 三天内统计
                sql_page_view_list2 = await conn.execute_query_dict(sql_page_view2)
                sql_page_view_list,sql_page_view_list2=mix_sql(sql_page_view_list, sql_page_view_list2)
        else:
            if day==0:#按天查询
...
async def UsHkrank(day: int,pid: int,user_id:  Optional[int] = 0):
    try:
        conn = Tortoise.get_connection("default")
        if  user_id:
            if day == 0:  # 按天查询
                # 搜索a，hk,us分布
                sql1 = f"""SELECT DATE_FORMAT(add_time,'%H') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="hk" and to_days(add_time)=to_days(now())  and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                sql2 = f""" SELECT DATE_FORMAT(add_time,'%H') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="us" and to_days(add_time)=to_days(now())  and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                hk = await conn.execute_query_dict(sql1)  # hk
                us = await conn.execute_query_dict(sql2)  # us


            elif day == 1:  # 按周查询
                sql1 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="hk" and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                sql2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="us" and date_sub(curdate(), INTERVAL 7 DAY) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time  """  #
                hk = await conn.execute_query_dict(sql1)  # hk
                us = await conn.execute_query_dict(sql2)  # us
            elif day == 2:  # 按月查询
                sql1 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="hk" and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                sql2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="us" and date_sub(curdate(), INTERVAL 30 DAY) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time  """  #
                hk = await conn.execute_query_dict(sql1)  # hk
                us = await conn.execute_query_dict(sql2)  # us
            elif day == 3:  # 按年查询
                sql1 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="hk" and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                sql2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="us" and date_sub(curdate(), INTERVAL 1 YEAR) <= date(add_time) and stock_type={pid} and user_id={user_id} GROUP BY  time  """  #
                hk = await conn.execute_query_dict(sql1)  # hk
                us = await conn.execute_query_dict(sql2)  # us
            else:  # 所有
                sql1 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="hk"  and stock_type={pid} and user_id={user_id} GROUP BY  time   """  #
                sql2 = f"""SELECT DATE_FORMAT(add_time,'%Y-%m-%d') as time,count(id)  cout FROM stock_view_count  WHERE  stock_mk="us"  and stock_type={pid} and user_id={user_id} GROUP BY  time  """  #
                hk = await conn.execute_query_dict(sql1)  # hk
                us = await conn.execute_query_dict(sql2)  # us
        else:
